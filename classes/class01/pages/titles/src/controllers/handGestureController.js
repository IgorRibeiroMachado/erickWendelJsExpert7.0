...
const { shouldRun: clickShouldRun } = prepareRunChecker({ timerDelay: 2000 })
...
export default class HandGestureController {
  ...
  async #loop() {
    ...
    this.#view.loop(this.#loop.bind(this)) // this da view (this da controller)
  }
