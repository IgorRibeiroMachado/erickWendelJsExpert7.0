export default class HandGestureView {
  ...
  #drawFingersAndHoverElements(keypoint) {
  ...
  #hoverElement(finger, points) {
    ...
    const tip = points.find(item => item.name === 'index_finger_tip') // isso n deveria estar na view, e sim em um service kkkk, mas fodasse
